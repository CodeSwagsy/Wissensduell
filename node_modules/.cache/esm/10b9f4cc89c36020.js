let readline,spielerArr,questionsHtml,questionsCss,questionsJavascript;_89c‍.x([["chooseCategory",()=>chooseCategory],["shuffleArray",()=>shuffleArray],["createPlayer",()=>createPlayer],["showResults",()=>showResults]]);_89c‍.w("readline-sync",[["default",["readline"],function(v){readline=v}]]);_89c‍.w("./main",[["spielerArr",["spielerArr"],function(v){spielerArr=v}]]);_89c‍.w("./questionList",[["questionsHtml",["questionsHtml"],function(v){questionsHtml=v}],["questionsCss",["questionsCss"],function(v){questionsCss=v}],["questionsJavascript",["questionsJavascript"],function(v){questionsJavascript=v}]]);
...
const GREEN = "\u001B[1m\u001B[32m",
  ...
  const categoryNum = _89c‍.a("readline",readline).questionInt(
    `${GREEN}
...
You choose a category: `
  ...
  switch (categoryNum) {
    case 1:
      res = makeQuestion(_89c‍.a("questionsHtml",questionsHtml));
      break;
    case 2:
      res = makeQuestion(_89c‍.a("questionsCss",questionsCss));
      break;
    case 3:
      res = makeQuestion(_89c‍.a("questionsJavascript",questionsJavascript));
      break;
    default:
...
function makeQuestion(category) {
  ...
  while (wasQuestion.length < category.length) {
    ...
    if (!wasQuestion.includes(index)) {
      ...
      shuffleArr.forEach((item, number) => {
        _89c‍.g.console.log(number + 1 + ".", item);
      });

      const userInput = _89c‍.a("readline",readline).question(
  ...
  let max = 0;
  let winner;
  _89c‍.a("spielerArr",spielerArr).forEach((player) => {

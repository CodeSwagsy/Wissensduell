let readline,questionsHtml,questionsCss;_9d1‍.x([["chooseCategory",()=>chooseCategory]]);_9d1‍.w("readline-sync",[["default",["readline"],function(v){readline=v}]]);_9d1‍.w("./questionList",[["questionsHtml",["questionsHtml"],function(v){questionsHtml=v}],["questionsCss",["questionsCss"],function(v){questionsCss=v}]]);
  ...
  while (wasQuestion.length < category.length) {
    ...
    if (!wasQuestion.includes(index)) {
      ...
      shuffleArr.forEach((item, number) => {
        _9d1‍.g.console.log(number + 1 + ".", item);
      });

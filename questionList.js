const questionsHtml = [
  {
    ...
    choices: ["Hypertext Markup Language", "Hyper Text Markup Logic", "High Text Making Language"],
  ...
  {
    question: "Wie Wie fügt man einen Link in HTML ein ?",
    choices: ["<link>", "<a>", "<href>"],
    correctAnswer: "<a>",
  },
  {
  ...
  },
  {
    ...
    choices: ["<img src=bild.jpg alt=Alternativer Text>", "<image src=bild.jpg alt=Alternativer Text>", "<picture src=bild.jpg alt=Alternativer Text>"], 
    correctAnswer: "<img src=bild.jpg alt=Alternativer Text>",
  },
  {
    question: "Wie erstellt man einen Hyperlink, der in einem neuen Tab geöffnet wird?",
    choices: ["<a href=linkziel.html target=_blank>Linktext</a>", "<a href=linkziel.html target=_self>Linktext</a>", "<a href=linkziel.html target=_parent>Linktext</a>"],
...
const questionsCss = [
  ...
  choices: ["line-height: height", "vertical-align: middle", "text-align: center"],
